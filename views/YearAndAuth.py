...
class YearAndAuth(QWidget):
    ...
    def __init__(self,mainwidget,buttons):
        ...
        '''Prepare the widgets'''
        Label1=QLabel("year (yyyy-mm-dd):")
        Label2=QLabel("id auther :")
    ...
    def query(self):
        year=self.input1.text()
        id_auth=self.input2.text()
        (rows,keys) = execute_query_seven(year,id_auth)
